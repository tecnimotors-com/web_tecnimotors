...
@Component({
  selector: 'app-listadorepuesto',
  imports: [SharedMain, PreloaderComponent],
  templateUrl: './listadorepuesto.component.html',
  styleUrls: ['./listadorepuesto.component.scss'],
})
export class ListadorepuestoComponent implements OnInit {
  ...
  public txtcategoria: string = localStorage.getItem('categoriarepuesto') || '';
  public txtmodelo: string = localStorage.getItem('modelorepuesto') || '';
  ...
  private initializeData(): void {
    ...
    this.ListarCategoriaRepuesto();
  }
  ListarCategoriaRepuesto() {
    this.maestroclasifi.getListadoRepuestoCategoria().subscribe({
      next: (lst: any) => {
  ...
  SelectMarca() {
    this.ListarGeneralRepuesto();
    localStorage.removeItem('pvehiculo');
    localStorage.setItem('modelorepuesto', this.txtmodelo);
  }
  ...
  ListarMarcaRepuesto() {
    ...
    this.maestroclasifi.getListadoRepuestoMarca(frombody).subscribe({
      next: (lst: any) => {
        this.ListModelo = lst;
      },
    });
  ...
  ListarGeneralRepuesto() {
    ...
    this.showAlert('Cargando Información....', 'info');
    this.maestroclasifi.getListadoGeneralRepuesto(frombody).subscribe({
      next: (lst: any) => {
