...
@Component({
  selector: 'app-detallecamaras',
  imports: [SharedMain, PreloaderComponent],
  templateUrl: './detallecamaras.component.html',
  styleUrls: ['./detallecamaras.component.scss'],
})
export class DetallecamarasComponent implements OnInit {
