...
const footerWidgetAccordion = function () {
  const footerElement = document.querySelector(".main__footer");

  // Verifica si el elemento existe
  if (footerElement) {
    accordion = false;
    footerElement.addEventListener("click", function (evt) {
   ...
   // console.warn("El elemento .main__footer no se encontró en el DOM.");
  }
};

// Función para verificar si el DOM está listo
const checkDOMReady = setInterval(() => {
  if (document.querySelector(".main__footer")) {
    clearInterval(checkDOMReady); // Detiene la verificación
    footerWidgetAccordion(); // Llama a la función cuando el elemento está disponible
  }
